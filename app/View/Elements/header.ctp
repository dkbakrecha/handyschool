            ...
            <div class="row">
                <div class="contact-info">
                    <ul class="nav navbar-nav">
                        ...
                        <li><i class="fa fa-envelope-o"></i> support@school.in</li>
                    </ul>
                </div>
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo $this->Html->url(array('controller' => 'rooms', 'action' => 'index')); ?>">
                <?php echo $this->Html->image('SBM-Logo.png', array('alt' => 'Room247.in', 'width' => '180')); ?>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li>
                    <a href = '<?php echo $this->Html->url(array('controller' => 'academic_enquiries', 'action' => 'admission')); ?>'>Admission</a>
                </li>
                <li>
                    <a href = '<?php echo $this->Html->url(array('controller' => 'events', 'action' => 'index')); ?>'>Events</a>
                </li>
                <li>
                    <a href = '<?php echo $this->Html->url(array('controller' => 'gallery', 'action' => 'index')); ?>'>Gallery</a>
                </li>
                <li>
            ...
            <ul class="nav navbar-nav pull-right menu-prifile">
                ...
                <?php } else {
                    ?>
                    <li>
                        <a href="<?php echo $this->Html->url(array('controller' => 'users', 'action' =>'login')); ?>" class="btn btn-primary green">Login</a>
                    </li>
